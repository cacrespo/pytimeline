...
urlpatterns = [
    ...
    path('board/join', JoinPlayRoom.as_view(), name="join-play-room"),
    path('board/join/<int:pk>/', JoinPlayRoom.as_view(), name="join-play-room"),

    path('board/<int:pk>/', PlayRoom.as_view(), name="play-room"),
